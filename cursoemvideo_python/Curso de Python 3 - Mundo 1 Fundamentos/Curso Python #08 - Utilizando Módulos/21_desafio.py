...
arquivo = 'C:/Users/mdbsi/OneDrive/Documentos/GitHub/meus-estudos/cursoemvideo_python/Curso de Python 3 - Mundo 1 Fundamentos/Curso Python #08 - Utilizando Módulos/21_desafio.mp3'
