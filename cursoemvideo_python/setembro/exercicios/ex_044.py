...
# SE FOR CARTAO, PEDE PARA ESCOLHER O TIPO
elif metodo == 2:
...
# SE FOR CARTAO DE CREDITO PERGUNTA SE É A VISTA OU PARCELADO
    else:
        credito = int(input(f"""
...
# SE FOR PARCELADO, PERGUNTA SE É EM DUAS VEZES OU MAIS
        else:
...
# SE FOR EM DUAS VEZES, NAO HA JUROS
            if parcelamento == 1:
                print(
...
# SE FOR EM 3 VEZES OU MAIS, PERGUNTA QUANTAS VEZES SERÁ
            else:
                parcelas = int(input(f'{cor["destaque"]}Digite o número de parcelas: 3 a 10{cor["fecha"]}'))

# DEPOIS INFORMA OS VALORES ATUALIZADOS
...
# SE MEIO DE PAGAMENTO FOR INVÁLIDO PERGUNTA NOVAMENTE
else:
