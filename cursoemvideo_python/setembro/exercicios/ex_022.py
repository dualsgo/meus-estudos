"""Desafio 022 - Analisador de textos (Aula 01 a 09): Crie um programa que leia o nome completo de uma pessoa e mostre:
...
nome = str(input('')).strip()  # Um input retorna um valor do tipo string por padrão
# Os espaços inúteis podem ser removidos nessa instância com strip, mas nesse exercício será feito posteriormente

# Passo 2: Tratar a string - Para fins didáticos e facilitar o entendimento vou armazenar cada resultado em uma variável
...
# Outra forma seria com uma expressão len(nome) - nome.count(' ') é o comprimento menos a quantidade de espaços
...
# Outra forma de fazer seria mostrando a primeira ocorrencia de espaço com nome.find(' ')
