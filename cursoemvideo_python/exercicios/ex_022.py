...
# Outra forma seria com uma espressão len(nome) - nome.count(' ') é o comprimento menos a quantidade de espaços
...
# Outra forma de fazer seria mostrano a primeira ocorrencia de espaço com nome.find(' ')
