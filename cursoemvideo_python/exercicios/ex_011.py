...
altura = float(input('Digite a altura da parede em centímetros: \n'))
print(f'A altura digitada foi: {altura:.0f} centimetros.\n')
largura = float(input('Digite a largura da parede em centímetros: \n'))
print(f'A largura digitada foi: {largura:.0f} centimetros.\n')
# Passo 2: Calcular a sua área e a quantidade de tinta necessária para pintá-la - Primeiro convertemos os valores fornecidos em centímetros para metros.
altura_em_m = altura / 100
largura_em_m = largura / 100
# Depois faremos o cálculo para saber a área em metro quadrado.
area = altura_em_m * largura_em_m
print(f"""
A sua parede tem {altura_em_m:.2f}m de altura.
A sua parede tem {largura_em_m:.2f}m de largura.
...
print(f"""
Para pintar toda a sua parede de {area:.2f}m² será necessário utilizar {litros}Ls de tinta.
""")
