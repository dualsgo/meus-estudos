"""Desafio 035 - Analisando Triângulo v1.0 (Aula 01 a 10): Desenvolva um programa que leia o comprimento o segmento de três retas e diga ao usuário se elas podem formar um triângulo. """
...
# SE os lados formarem um triângulo
if triangulo:
    print(
