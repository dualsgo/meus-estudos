...
# Passo 2: Ler o número - Utilizamos uma variável para armazenar o valor solicitando que o usuario digite um numero com a função input e a função int para converter a string para inteiro
...
print('====================================')
# Uma opção é usar a função int() a outra é ralizar as operações matemáticas.
