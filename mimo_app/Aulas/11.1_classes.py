...
# Criamos um método para facilitar a impressão dos atributos do objeto. Chamamos o método print_specs no objeto
# low_spec. Mas poderíamos executar os print() diretamente. Assim:
print("Low spec Computer:")
