...
# Em vez disso, podemos coletar dados relacionados numa lista usando [ e ]
# Os valores ou dados numa lista são chamados de elementos.
# Para criar uma lista vazia, codificamos o nome da lista e []
lista = []

# Usamos vírgula para separa dois ou mais valores em uma list.
