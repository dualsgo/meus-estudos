...
exemplo_snake_case = 'Parece um cobra'

# Para nos ajudar a entender o que está numa variável, escolhemos nomes descritivos.
ano_atual = 2023
...
# As variáveis podem conter todos os tipos de valores. Vamos dar uma olhada no armazenamento de valores de texto.
